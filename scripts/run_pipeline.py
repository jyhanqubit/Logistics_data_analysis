...
def main() -> None:
    ...
    if not prepared:
        print("[1/7] Using synthetic fallback dataset...")
    ...
    print("[4/7] Training demand forecasting model...")
    ...
    print("[5/7] Running recommendation system...")
    ...
    print("[6/7] Running optimization experiments...")
    ...
    print("[7/7] Running OMS/WMS/TMS ops simulation and report generation...")
